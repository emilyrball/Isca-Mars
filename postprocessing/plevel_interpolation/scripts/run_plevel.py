...
base_dir='$GFDL_DATA'
exp_name_list = ['soc_mars_mk36_per_value70.85_none_mld_2.0_lh_rel']
...
if level_set=='standard':
    ...
    plevs['daily']  =' -p "0.01 0.1 1 10 20 30 50 75 100 125 150 175 200 225 250 275 280 285 290 295 300 305 310 315 320 325 330 335 340 345 350 375 380 385 390 395 400 405 410 415 420 425 435 445 455 465 475 485 495 505 515 525 535 545 555 565 575 585 595 605 615 625"'
